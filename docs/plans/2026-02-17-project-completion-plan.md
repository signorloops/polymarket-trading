...
```bash
cd /Users/linus/Documents/vibe-coding/polymarket/.worktrees/feature/polymarket-trading
npm run lint -- --fix
```
...
```bash
git worktree remove /Users/linus/Documents/vibe-coding/polymarket/.worktrees/feature/polymarket-trading
```
